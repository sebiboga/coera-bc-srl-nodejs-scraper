...
| group        | string   | Parent company group (e.g. "COERA BC") |
...
- **scraperFile**: Full URL to GitHub raw workflow YML (e.g. `https://raw.githubusercontent.com/sebiboga/coera-bc-srl-nodejs-scraper/main/.github/workflows/job-seeker-ro-spider.yml`)